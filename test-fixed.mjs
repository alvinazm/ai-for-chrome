#!/usr/bin/env node
/**
 * Test with the FIXED function - keeps tool_call content
 */
...
const testCases = [
  {
    ...
    input: `<tool_call>{"action":[{"click_element":{"index":25}},{"click_element":{"index":28}}],"current_state":{"evaluation_previous_goal":"Success","memory":"","next_goal":""}}</tool_call>`,
  },
  {
    name: 'Test 2: With think tags',
    input: `<think>The user wants me to navigate to a URL.
...
for (const tc of testCases) {
  ...
  try {
    ...
    console.log('After removeThinkTags:', cleaned.substring(0, 60));
